...
| --- | :---: | --- |
| [`quick-start/`](./quick-start/) | No | The minimum one-shot path: `runAcpAgent({ profile, cwd, prompt })` returning an async iterable of raw ACP `session/update` notifications. Process is auto-disposed. |
